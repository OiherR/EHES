...
public class testBlindEguneratu {
    ...
    // Argumentuak egiaztatzeko metodoa
    private static void validateArguments(String[] args) {
        if (args.length != 4) {
            System.err.println("Uso: java testBlindEguneratu <train.arff> <test_blind.arff> <output.arff> <num_predictors>");
            System.err.println("Ejemplo: java testBlindEguneratu train.arff test_blind.arff test_normalized.arff 500");
            System.exit(1);
        }
    }
    ...
    // Egitura normalizatzeko metodoa nagusia
    ...
    // Atributu mapa sortzeko metodoa
    ...
    // Predictoreak gehitzeko metodoa
    private static void addPredictors(Instances trainData, Map<String, Integer> testAttrMap,ArrayList<Attribute> newAttributes, List<Integer> attrMapping, int predictorsCount) {
    ...
    // Klase atributua gehitzeko metodoa
    private static void addClassAttribute(Instances testData, Instances trainData,Map<String, Integer> testAttrMap,ArrayList<Attribute> newAttributes,
    ...
    private static Instances createNormalizedDataset(String relationName,ArrayList<Attribute> attributes,Instances testData,
     List<Integer> attrMapping,int requiredAttributes,int predictorsCount) {
    ...
    // Arrakasta mezua erakusteko metodoa
